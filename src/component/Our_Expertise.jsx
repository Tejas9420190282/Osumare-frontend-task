...
import icon1 from "../assets/img/Our_Expertise/icon1.png";
import icon2 from "../assets/img/Our_Expertise/icon2.png";
import icon3 from "../assets/img/Our_Expertise/icon3.png";
import icon4 from "../assets/img/Our_Expertise/icon4.png";
    ...
    const features1 = [
        {
            img: icon1,
            head: "Effective CTAs",
            para: "See how our strategic CTAs drove a seficant increase in property inquiries and accelerated sales for a real estate agency.",
        },
        {
            img: icon2,
            head: "Conversion-optimized Landing Pages",
